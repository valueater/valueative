...
지속 가능한 지구의 내일을 설계하는 천연 적토이암 규격화 소재 전문 기업

---

## 📋 프로젝트 개요

SMGM 웹사이트는 천연 적토이암을 규격화(CORElite-G 시스템)하여 공급하는 소재 전문 기업의 공식 홈페이지입니다. 5가지 핵심 솔루션을 통해 맨발걷기길, 자전거 도로, 버스전용차로, 학교 운동장, 농업 토양개량 등 다양한 분야에 친환경 고기능성 소재를 제공합니다.
